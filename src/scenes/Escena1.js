class Escena1 extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.puntaje >= 10) { //puntaje para que pase a la siguiente escena
            ...
            this.scene.start('Jefe2', { puntaje: this.puntaje, puntajeMaximo: this.puntajeMaximo, posicionNave });// Cambiar a la siguiente escena y pasa el puntaje
        }
    }
